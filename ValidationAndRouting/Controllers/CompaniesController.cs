...
namespace ValidationAndRouting.Controllers
{
    ...
    public class CompaniesController : ControllerBase
    {
        ...
        {
            var company =
                _repository.Company.GetCompany(id, trackChanges: false);

            if (company == null)
            {
                // _logger.LogInfo(
                //     $"Company with id: {id} doesn't exist in the database.");
            ...
            [FromBody] CompanyForCreationDto company)
        {
            ...
            {
                // _logger.LogError(
                //     "CompanyForCreationDto object sent from client is null.");
            ...
            {
                // _logger.LogError(
                //     "Invalid model state for the CompanyForCreationDto object");
            ...
            [FromBody] CompanyForUpdateDto company)
        {
            ...
            {
                // _logger.LogError(
                //     "CompanyForUpdateDto object sent from client is null.");
            ...
            {
                // _logger.LogError(
                //     "Invalid model state for the CompanyForUpdateDto object");
