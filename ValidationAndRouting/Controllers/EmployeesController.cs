...
namespace ValidationAndRouting.Controllers
{
    ...
    public class EmployeesController : ControllerBase
    {
        ...
        {
            var company =
                _repository.Company.GetCompany(companyId,
                    trackChanges: false);
        ...
        public IActionResult GetEmployeeForCompany(
            Guid companyId,
            Guid id)
        {
            var company =
            ...
            var employeeDb =
                _repository.Employee.GetEmployee(
                    companyId,
                    id,
                    trackChanges: false);
            ...
            {
                // _logger.LogInfo(
                //     $"Employee with id: {id} doesn't exist in the database.");
            ...
            [FromBody] EmployeeForCreationDto employee)
        {
            ...
            {
                // _logger.LogError(
                //     "EmployeeForCreationDto object sent from client is null.");

                return BadRequest(
                    "EmployeeForCreationDto object is null");
            }
        ...
        [HttpDelete("{id}")]
        public IActionResult DeleteEmployeeForCompany(
            Guid companyId,
            Guid id)
        {
            var company =
            ...
            [FromBody] EmployeeForUpdateDto employee)
        {
            ...
            {
                // _logger.LogError(
                //     "EmployeeForUpdateDto object sent from client is null.");

                return BadRequest(
                    "EmployeeForUpdateDto object is null");
            }

            if (!ModelState.IsValid)
            {
                // _logger.LogError(
                //     "Invalid model state for the EmployeeForUpdateDto object");
